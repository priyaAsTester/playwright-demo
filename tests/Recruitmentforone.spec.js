...
test.only('test', async ({ page }) => {
 await page.goto("https://myrecruit.qacri.com/onboarding/personal-details/eyJpdiI6InNXR0xGS3EvWk1MK29vSVZNdElNc0E9PSIsInZhbHVlIjoiTW5NZlpibDJEZlhab0JWcWdoWE5Ndz09IiwibWFjIjoiOTc1ZDliNjMyZTM3NTllMDI1NmU0NWM1MTA5Nzk3MWJjNjIxYjJiMDcwODM2ZDc4ZTI1ZWVmYmNkOWZkYjg5MSIsInRhZyI6IiJ9")
...
//   await page.getByRole('textbox', { name: 'PAN Number*' }).fill('JHDGT3764f');
//   await page.waitForTimeout(2000)

  
//   await page.getByRole('textbox', { name: 'Aadhar Number*' }).click();
//   await page.getByRole('textbox', { name: 'Aadhar Number*' }).fill('787624567079');
...
//   await page.getByRole('textbox', { name: 'UAN Number' }).fill('100156756675');
//    await page.waitForTimeout(2000)
